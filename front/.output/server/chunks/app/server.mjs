import { version as version$1, unref, inject as inject$1, watch, onScopeDispose, Fragment, reactive, computed, watchEffect, toRefs, capitalize, isVNode, Comment, warn, ref, provide, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, toRaw, createVNode, mergeProps, h, shallowReactive, Suspense, nextTick, Transition, hasInjectionContext, effectScope, shallowRef, useSSRContext, createApp, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, isReadonly, isRef, isShallow, isReactive, withCtx } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-063ad2c2.mjs').then((m) => m.default || m)
  },
  {
    name: "ssl",
    path: "/ssl",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ba257068.mjs').then((m) => m.default || m)
  }
];
...
const components_plugin_4KdhiGzXtu = /* @__PURE__ */ defineNuxtPlugin({
...
const options = JSON.parse('{"ssr":true,"treeshaking":true,"useVuetifyLabs":true,"theme":{"defaultTheme":"temaCustomizado","themes":{"temaCustomizado":{"dark":true,"colors":{"background":"#660000","surface":"#FFFFFF","primary":"#6200EE","primary-darken-1":"#3700B3","secondary":"#03DAC6","secondary-darken-1":"#018786","error":"#B00020","info":"#2196F3","success":"#4CAF50","warning":"#FB8C00"}}}}}');
const templates_plugin_ddb0d080_WdjWTFPfqm = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  ...
  components_plugin_4KdhiGzXtu,
  templates_plugin_ddb0d080_WdjWTFPfqm
];
const layouts = {
  default: () => import('./_nuxt/default-7792b781.mjs').then((m) => m.default || m)
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, { class: "layouts" }, {
...
export { findChildrenWithProvide as $, getCurrentInstance as A, defineComponent as B, deprecate as C, convertToUnit as D, EventProp as E, getPropertyFromItem as F, focusChild as G, destructComputed as H, IconValue as I, consoleError as J, clamp as K, refElement as L, IN_BROWSER as M, useToggleScope as N, focusableChildren as O, getNextElement as P, debounce as Q, ensureValidVNode as R, defineFunctionalComponent as S, getObjectValueByPath as T, isEmpty as U, consoleWarn as V, breakpoints as W, getCurrentInstanceName as X, pick as Y, callEvent as Z, _export_sfc as _, useRuntimeConfig as a, SUPPORTS_INTERSECTION as a0, includes as a1, isCssColor as a2, isParsableColor as a3, parseColor as a4, getForeground as a5, useIcon as a6, flattenFragments as a7, hasEvent as a8, isObject as a9, keyCodes as aa, navigateTo as b, createError as c, isOn as d, entry$1 as default, eventName as e, useProxiedModel as f, genericComponent as g, useLocale as h, injectHead as i, useRtl as j, provideTheme as k, useDisplay as l, makeThemeProps as m, nuxtLinkDefaults as n, provideDefaults as o, propsFactory as p, createRange as q, resolveUnrefHeadInput as r, keyValues as s, deepEqual as t, useRouter as u, getUid as v, filterInputAttrs as w, wrapInArray as x, matchesSelector as y, omit as z };
